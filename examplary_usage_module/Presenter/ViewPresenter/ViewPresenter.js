                ...
                eventListener: function(event) {
                    ...
                    */
                    function onLoadNextViewResources_I_1L(event) {
                        ...
                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onGetNextViewTemplate.eventName, details);
                                ...
                                */
                                ...
                                function onCSSLoad_I_4L() {
                                    ...
                                    if(nextViewTemplateMetadata.css.waitForLoad) {
                                        ...
                                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statefulEvents.onCSSLoaded.eventName, secondLevelEventDetails);
                                    }
                                }
                            }
                        }
