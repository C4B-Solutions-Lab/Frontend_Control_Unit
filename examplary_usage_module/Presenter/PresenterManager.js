...
(function () {
    ...
    var _CORE_OBJECT = {
        __init__: function () {
            ...
            // setup event flow
            ebdoAPI.bindListenersWithEvents([_EVENTS_OBJECT.initEvents, _EVENTS_OBJECT.statefulEvents, _EVENTS_OBJECT.nextViewEvents, _EVENTS_OBJECT.rollbackEvents]);
        },
                    ...
                    */
                    function onPresenterViewReady_I_1L(self) {
                        ...
                        if(_EVENTS_OBJECT.statefulEvents.onPresenterViewMetadataReady.hasCompleted && _EVENTS_OBJECT.statefulEvents.onPresenterModelReady.hasCompleted) {
                            // return control to MFCU
                            ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onPresenterReady.eventName);
                        }
                    }
                },
                ...
                eventListener: function() {
                    ...
                    */
                    function onGetNextView_I_1L() {
                        ...
                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onLoadNextViewResources.eventName, _EVENTS_OBJECT.nextViewEvents.onGetNextView);
                    }
                },
                ...
                eventListener: function(event) {
                    ...
                    */
                    function onGotNextViewResources_I_1L(event) {
                        ...
                        // if view's resources and model's resources were successfully loaded up, notify MFCU, i.e. dispatch work to a MCU's binder
                        if(isNextViewReady) {
                        ...
                        */
                        function onBindingCompleted_I_2L(isWorkflowCompleted, flowNavigation) {
                            ...
                            if(!isWorkflowCompleted && !flowNavigation.userYieldsNextView) {
                                ...
                                ebdoAPI.dispatchEvent(_EVENTS_OBJECT.nextViewEvents.onGetNextView.eventName);
                            }
                ...
                eventListener: function(event) {
                    ...
                    */
                    function onRemoveCurrentView_I_1L(event) {
                        ...
                        ebdoAPI.bindListenersWithEvents([{nextViewEvents: _EVENTS_OBJECT.nextViewEvents.onGetNextView}], true);

                        // reset current view i.e. view's template metadata object internals as well as view's model metadata object internals
                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onResetCurrentView.eventName, event.detail);
                    }
                }
            },
                    ...
                    */
                    function onResetCurrentViewTemplateMetadata_I_1L(self, eventObject) {
                        ...
                        if(_EVENTS_OBJECT.rollbackEvents.onResetCurrentViewModelMetadata.hasCompleted) {
                            ...
                            ebdoAPI.bindListenersWithEvents([{nextViewEvents: _EVENTS_OBJECT.nextViewEvents.onGetNextView}]);
