                    ...
                    */
                    function onModelCoreReady_I_1L(self) {
                        ...
                        if(_EVENTS_OBJECT.statefulEvents.onModelMetadataReady.hasCompleted) {
                            ...
                            ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onModelReady.eventName);
                        }
                    }
                },
                            ...
                            ral.GET_RAL_OBJECT.Loader.loadAsync(
                                                                    ...
                                                                    */
                                                                    function () {
                                                                        ...
                                                                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.nextViewEvents.onNextViewModelPhysicallyLoaded.eventName, secondLevelEventDetails);
                                                                    }
                                                               );
                        }
                        else {
                ...
                eventListener: function(event) {
                    ...
                    */
                    function onNextViewModelPhysicallyLoaded_I_1L(event) {
                        ...
                        if(nextViewModel) {
                            ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onViewModelExposeYourData.eventName, [nextViewModel.isLast, processNextViewModelCallback, handleViewModel_I_2L]);
                        }
                        else {
                ...
                eventListener: function(event) {
                    ...
                    */
                    function onResetCurrentViewModelMetadata_I_1L(eventObject) {
                        ...
                        ebdoAPI.dispatchEvent(_EVENTS_OBJECT.statelessEvents.onResetCurrentViewModelMetadata.eventName, eventObject.detail);
                    }
                }
            }
        }
